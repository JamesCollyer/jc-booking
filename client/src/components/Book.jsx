...
import stripeImg from '../assets/logo.svg'
  ...
  useEffect(() => {
    const makeRequest = async () => {
        try{
            ...
            {
              headers: {token: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYzNWE5YzY2NGRlYTViYjg3MmZjMjEzMSIsImlzQWRtaW4iOmZhbHNlLCJpYXQiOjE2Njc0NTcxOTh9.KIDNXRkoxEkh6B3E-jAe1OOFGiqf1OOn2DlQbV6BIgE`}
            })
        } catch(err){}
    }
    stripeToken &&  
